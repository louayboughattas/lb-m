...
<!-- Mirrored from silicon.createx.studio/account-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Nov 2022 19:57:43 GMT -->
      ...
      <section class="position-relative h-100 pt-5 pb-4">
        ...
        <div class="container d-flex flex-wrap justify-content-center justify-content-xl-start h-100 pt-5">
          <div class="w-100 align-self-end pt-1 pt-md-4 pb-4" style="max-width: 526px;">
            ...
            <form  class="needs-validation" novalidate  action="php/signup.php" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="position-relative mb-4">
                    ...
                    <input type="name"  id="name" class="form-control form-control-lg" required name="uname"
                ...
                <div class="col-12 mb-4">
                  ...
                  <div class="password-toggle">
                    <input type="password"  name="pass" id="password-confirm" class="form-control form-control-lg" required>
                    <label class="password-toggle-btn" aria-label="Show/hide password">
                      <input class="password-toggle-check" type="checkbox">
                      <span class="password-toggle-indicator"></span>
                    </label>
