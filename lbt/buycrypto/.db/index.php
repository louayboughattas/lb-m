        ...
        <div class="row">
          ...
          <div class="col-md-8 offset-lg-1 pb-5 mb-2 mb-lg-4 pt-md-5 mt-n3 mt-md-0">
            <div class="ps-md-3 ps-lg-0 mt-md-2 py-md-4">
              <h1 class="h2 pt-xl-1 pb-3">Buy CRYPTO-D17</h1>
              ...
              <form class="needs-validation border-bottom pb-2 pb-lg-4" novalidate action="php/signup.php" 
    	      method="post"
		    ...
		    <?php } ?>
                ...
                <div class="row pb-2">
                  <div class="col-sm-6 mb-4">
                    <label for="country" class="form-label fs-base">CRYPTO</label>
                    ...
                    <div class="invalid-feedback">Please choose your NETWORK!</div>
                  </div>
                  <div class="col-sm-6 mb-4">
                    <label for="state" class="form-label fs-base">NETWORK</label>
                    <select id="state"  name="uname" value="<?php echo (isset($_GET['uname']))?$_GET['uname']:"" ?>" class="form-select form-select-lg" required>
                      ...
                      <option value="BNB(BEP20)">BSC(BEP20)</option>
                  ...
                  <div class="col-12 mb-4">
                    ...
                    <input type="file"  name="pp" id="pic" required data-parsley-trigger="keyup" class="form-control form-control-lg" />
